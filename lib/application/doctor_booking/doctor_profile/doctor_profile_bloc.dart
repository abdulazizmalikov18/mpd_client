...
class DoctorProfileBloc extends Bloc<DoctorProfileEvent, DoctorProfileState> {
  DoctorProfileBloc(this._profileRepository) : super(DoctorProfileInitial(null, username: '')) {
  ...
  void _onUpdateDoctorSubscription(UpdateDoctorSubscription event, Emitter<DoctorProfileState> emit) {
    // state.doctor!.isWorking = event.doctorSubscribed;
  }

  Future<void> _onGetDoctorData(GetDoctorPprofileData event, Emitter<DoctorProfileState> emit) async {
