...
// import '../../../data/repositories/appoinment_repository.dart';

// part 'canceled_appointment_event.dart';
// part 'canceled_appointment_state.dart';

// class CanceledAppointmentBloc
//     extends Bloc<CanceledAppointmentEvent, CanceledAppointmentState> {
//   CanceledAppointmentBloc(this._profileRepository)
//       : super(CanceledAppointmentInitial()) {
//     on<GetCanceledAppoinmentsEvent>(_onGetAppoinmentsEvent,
...
//   //get records
//   Future<void> _onGetAppoinmentsEvent(GetCanceledAppoinmentsEvent event,
//       Emitter<CanceledAppointmentState> emit) async {
...
//           .getUserAppoinments(PaginationModel(limit: _limit, status: -1));
//       if (result.isRight) {
//         _offset += 10;
...
//         PaginationModel(limit: _limit, status: -1, offset: _offset));
//     if (result.isRight) {
//       _offset += 10;
...
//       emit(CanceledAppoinmentSuccess(
//           appoinments:
//               event.isRefresh ? result.right.results : canceledAppointments,
//           hasReachedMax: canceledAppointments.length < _offset));
//     } else {
//       errorChecker(result.left, emit);
//     }
//   }
...
//       emit(CanceledAppoinmentsFailure(
//           appoinments: state.appoinments, failure: failure.message));
//     } else {
//       emit(CanceledAppoinmentsFailure(
