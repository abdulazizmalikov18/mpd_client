                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Text('${Utils.priceFormat(localProducts[i].price)} UZS',
                            style: Styles.headline7Sp14
                                .copyWith(fontFamily: Styles.gilroyMedium, color: context.color.mainBlue)),
                      ],
                    ),
                    const Spacer(),
                    Text(
                      'x ${localProducts[i].count}',
                      style: Styles.boldTopHint.copyWith(color: context.color.black, fontSize: 16.sp),
                    ),
                  ],
                ),
              ),
                  ...
                  MaterialButton(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(
                          'View records',
                          style: Styles.headline7.copyWith(color: context.color.mainBlue, fontSize: 14),
                        ),
                        SvgPicture.asset(
                          AppIcons.forward,
