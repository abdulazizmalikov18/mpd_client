...
class Region {
  Region({required this.id, required this.name, this.isParent, this.type});
...
class RegionType {
  RegionType({required this.id, required this.name});

  int id;
  String name;

  factory RegionType.fromJson(Map<String, dynamic> json) =>
      RegionType(id: json["id"], name: json["name"]);
}
