  ...
  Failure _handleError(DioException error) {
    switch (error.type) {
      ...
      case DioExceptionType.receiveTimeout:
        _errorFailure = const ServerTimeOutFailure(message: 'Recieve timeOut');
        break;
      ...
      case DioExceptionType.cancel:
        _errorFailure = const ServerCancelFailure(message: 'Server Canceled');
        break;
      case DioExceptionType.unknown:
        _errorFailure = const ServerUnknownFailure(message: 'Someting wrong');
        break;
