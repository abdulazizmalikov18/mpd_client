      ...
      children: [
        LayoutBuilder(
          builder: (context, constraints) {
            double aspectRatio = ResponsiveValue<double>(
              context,
              conditionalValues: [
            ...
            double height = ResponsiveValue<double>(
              context,
              conditionalValues: [
                Condition.equals(name: MOBILE, value: 400),
                Condition.equals(
                  name: TABLET,
                  value: constraints.maxWidth / aspectRatio,
                ),
            ...
            double width = ResponsiveValue<double>(
              ...
              conditionalValues: [
                Condition.equals(
                  name: MOBILE,
                  value: constraints.maxWidth * 0.7,
                ),
                  ...
                  AspectRatio(
                    ...
                    child: cameraRenderer != null
                        ...
                        : Container(
                            ...
                            child: const Center(
                              child: Text("Camera is turned off"),
                            ),
                          ),
                  ),
                  Positioned(
