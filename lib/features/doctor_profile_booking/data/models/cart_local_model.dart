...
List<CartLocalModel> cartLocalModelFromJson(String str) =>
    List<CartLocalModel>.from(
      json.decode(str).map((x) => CartLocalModel.fromJson(x)),
    );

String cartLocalModelToJson(List<CartLocalModel> data) =>
