...
class MyPaymentRadioTile<T> extends StatelessWidget {
        ...
        child: Row(
          children: [
            ...
            if (extraText != null)
              Text(
                extraText!,
                style: Styles.headline5.copyWith(color: context.color.black),
              ),
          ],
        ),
      ),
  ...
  Widget _buildImage() {
    return Image.asset(imagePath, height: 24.h, fit: BoxFit.fill);
  }
  ...
  Widget _buildText(BuildContext context) {
    ...
    return Text(
      ...
      style: Styles.descSubtitle.copyWith(
        fontSize: 18.sp,
        color: isSelected ? context.color.mainBlue : context.color.black,
      ),
    );
  }
}
