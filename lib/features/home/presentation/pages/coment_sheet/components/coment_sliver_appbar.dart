...
class ComentSliverAppBar extends StatelessWidget {
  ...
  const ComentSliverAppBar({super.key, required this.title, required this.backPressed, required this.morePressed});
  ...
  Widget build(BuildContext context) {
    return SliverAppBar(
      ...
      title: Text(title, style: Styles.headline4.copyWith(
