...
abstract interface class ChatService {
  ...
  Future<ResponseHandler<GenericPagination<ChatGroupModel>>> getGroups(GetGroupChatEntity param);

  Future<ResponseHandler<GenericPagination<MessageModel>>> getMessages(GetChatEntity param);
  Future<bool> readAllMessage(String groupSlug);

  Future<ResponseHandler<GenericPagination<MessageModel>>> sendMessage(SendMessageEntity param);
...
class ChatServiceImpl extends ChatService {
  ...
  @override
  Future<ResponseHandler<GenericPagination<ChatGroupModel>>> getGroups(GetGroupChatEntity param) async {
