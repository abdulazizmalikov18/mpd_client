...
class SetBrandPage extends StatefulWidget {
  const SetBrandPage({super.key});

  @override
  State<SetBrandPage> createState() => _SetBrandPageState();
}

class _SetBrandPageState extends State<SetBrandPage> {
            ...
            listener: (context, state) {
              if (state.next) {
                Navigator.of(context).pushReplacement(
                    AppRoutes.setModel(context, state.brandValueId.toString()));
              }
                                  ...
                                  onTap: () {
                                    context.read<SearchBloc>().add(
                                        SearchEvent.setFilterValue(
                                            value: state.brandTopList?[index]
                                                    .name ??
                                                "",
                                            valueId:
                                                state.brandTopList?[index].id ??
                      ...
                      StickyHeader(
                        header: Container(
                          ...
                          padding: EdgeInsets.symmetric(
                              horizontal: 12.0.w, vertical: 8.h),
                          child:
                              Text("all_brands".tr(), style: fonts.subtitle1),
                        ),
                        content: ListView.separated(
                            ...
                            itemBuilder: (context, index) {
                              return ModelListItem(
                                ...
                                onTap: () {
                                  context.read<SearchBloc>().add(
                                      SearchEvent.setFilterValue(
                                          value: state.brandList?[index].name ??
                                              "",
                                          valueId:
