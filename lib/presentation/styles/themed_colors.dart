...
class ThemedColors extends ThemeExtension<ThemedColors> {
  ...
  ThemeExtension<ThemedColors> lerp(ThemeExtension<ThemedColors>? other, double t) {
    ...
    return ThemedColors(
      ...
      whiteSmokeToNightRider: Color.lerp(whiteSmokeToNightRider, other.whiteSmokeToNightRider, t) ?? whiteSmokeToNightRider,
      whiteToNero: Color.lerp(whiteToNero, other.whiteToNero, t) ?? whiteToNero,
      mediumSlateBlueToDolphin: Color.lerp(mediumSlateBlueToDolphin, other.mediumSlateBlueToDolphin, t) ?? mediumSlateBlueToDolphin,
      ...
      whiteWithOpacity90ToNero: Color.lerp(whiteWithOpacity90ToNero, other.whiteWithOpacity90ToNero, t) ?? whiteWithOpacity90ToNero,
      ...
      whiteLilacToNightRider: Color.lerp(whiteLilacToNightRider, other.whiteLilacToNightRider, t) ?? whiteLilacToNightRider,
      midnightExpressToGreySuit: Color.lerp(midnightExpressToGreySuit, other.midnightExpressToGreySuit, t) ?? midnightExpressToGreySuit,
      ...
      solitudeToDolphinBorder: Color.lerp(solitudeToDolphinBorder, other.solitudeToDolphinBorder, t) ?? solitudeToDolphinBorder,
      ...
      midnightExpressToWhite: Color.lerp(midnightExpressToWhite, other.midnightExpressToWhite, t) ?? midnightExpressToWhite,
      ...
      dividerColorToWhiteOpacity: Color.lerp(dividerColorToWhiteOpacity, other.dividerColorToWhiteOpacity, t) ?? dividerColorToWhiteOpacity,
      whiteLilacToWhiteLilac10: Color.lerp(whiteLilacToWhiteLilac10, other.whiteLilacToWhiteLilac10, t) ?? whiteLilacToWhiteLilac10,
      ...
      mediumSlateBlueToWhite: Color.lerp(mediumSlateBlueToWhite, other.mediumSlateBlueToWhite, t) ?? mediumSlateBlueToWhite,
      lightSlateBlue12ToLightSlateBlue: Color.lerp(lightSlateBlue12ToLightSlateBlue, other.lightSlateBlue12ToLightSlateBlue, t) ?? lightSlateBlue12ToLightSlateBlue,
      ...
      solitudeBorderToSolitudeBorder10: Color.lerp(solitudeBorderToSolitudeBorder10, other.solitudeBorderToSolitudeBorder10, t) ?? solitudeBorderToSolitudeBorder10,
      ...
      lavenderBlueToCharcoal: Color.lerp(lavenderBlueToCharcoal, other.lavenderBlueToCharcoal, t) ?? lavenderBlueToCharcoal,
      solitudeContainerToBlack: Color.lerp(solitudeContainerToBlack, other.solitudeContainerToBlack, t) ?? solitudeContainerToBlack,
      solitudeContainerToNero1: Color.lerp(solitudeContainerToNero1, other.solitudeContainerToNero1, t) ?? solitudeContainerToNero1,
