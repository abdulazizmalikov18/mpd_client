              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: _buildDrInfo(specialist, context),
                    ),
                  ],
                ),
              ),
  ...
  RichText _buildPrice(BuildContext context) {
    return RichText(
      text: TextSpan(children: [
        TextSpan(
            text:
                drCardInfo == DrCardInfo.completed ? '50 000 UZS\n' : '0 UZS\n',
            style: Styles.descSubtitle.copyWith(
                color: context.color.black, fontWeight: FontWeight.w600)),
        TextSpan(
          ...
          children: [
            SvgPicture.asset(
              ...
              colorFilter: ColorFilter.mode(
                  (statusColor ?? context.color.white), BlendMode.srcIn),
              height: 12.h,
              width: 12.h,
            ),
              ...
              child: Row(
                children: [
                  SvgPicture.asset(
                    ...
                    width: 12.h,
                    colorFilter:
                        ColorFilter.mode(context.color.yellow, BlendMode.srcIn),
                  ),
                  ScreenUtil().setHorizontalSpacing(2.w),
                  Text(
                    '4.7',
                    style: Styles.boldTopHint
                        .copyWith(color: context.color.black, fontSize: 10),
                  ),
                  ScreenUtil().setHorizontalSpacing(2.w),
                  Text(
                    '(50 reviews)',
