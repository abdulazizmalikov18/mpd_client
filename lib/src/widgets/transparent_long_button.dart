  ...
  Widget build(BuildContext context) {
    return Container(
        ...
        decoration: BoxDecoration(
            ...
            border: Border.all(width: 1, color: (borderColor ?? context.color.transparentBorder)),
        ...
        child: TextButton(
          ...
          child: Row(
            ...
            children: [
              ...
              Text(
                buttonName,
                style: Styles.boldHeadline6.copyWith(color: (textColor ?? context.color.grey), fontSize: fontsize),
              ),
            ],
          ),
        ));
